...
>
	...
	<div class="flex items-center gap-5">
		<a
			href="/login"
			class="text-sm text-ink-soft transition hover:text-ink dark:hover:text-[#f2f2f2]"
		>
			Sign in
		</a>
		<a
	...
	<a
		...
		target="_blank"
		rel="noopener"
		class="flex items-center gap-2 text-sm text-ink-soft transition hover:text-ink"
	>
